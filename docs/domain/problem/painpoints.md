...
| # | Pain Point | Kontext / Zitat | Quelle | Datum | Schweregrad |
|---|---|---|---|---|---|
| 1 | Einarbeitung dauert bis zu 3 Wochen; Fehler durch große Anzahl an Sonderregeln | Neue Mitarbeiter brauchen wochenlang bis zur Produktivität. Sonderregeln sind nicht zentral dokumentiert — Wissen steckt bei einzelnen Personen. | Hotels | 25.04.2026 | Hoch |
...
| 3 | Keine Konsistenz beim Rechnungsversand an Reiseveranstalter | Manchmal werden Rechnungen über das System an Reiseveranstalter versendet, manchmal nicht. Es gibt keinen einheitlichen Prozess — abhängig von Mitarbeiter oder Situation. | Hotels | 25.04.2026 | Mittel |
